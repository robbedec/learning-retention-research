...
\begin{document}
 ...
 Algemeen zullen we in deze studie eerst kijken of we een verschil zien in de resultaten bij studenten die Retrieval Practice toepasten en degene die dit niet deden. We zullen dit doen door een data-analyse in het programma R. Daarnaast kiezen we verder ook nog variabelen die mogelijks de resultaten zullen beïnvloeden en maken we ook hier grafieken van.
    ...
    We verwachten dat de studenten die Retrieval Practice toepasten, beter zullen scoren op de test. De groepen die naar muziek luisterden, zullen iets minder scoren dan de groepen die dit niet deden omdat dit 
    eventueel als een afleiding kan gezien worden. 
    
	Als parameters van deze studie hebben we ons vooral gebaseerd op de achtergrond en ervaring van de student. We kijken naar de achtergrond van de ouders, die van de student, en zijn eerdere studierichtingen. Deze pijlers hangen goed samen omdat ze een beeld geven over de situatie van de student. Een student met ouders die een universitair diploma kan bijvoorbeeld meer gestimuleerd worden of meer motivatie hebben om dat ook te behalen. We lichten de hypotheses nu verder toe.
    
    Onze eerste hypothese is dat studenten met een hoog aantal uren wiskunde beter zullen scoren dan die met een laag aantal uren wiskunde (minder dan 4 uur). 
    ...
    We denken ook dat studenten met minstens één ouder met universitair diploma, hoger zullen scoren dan studenten die ouders hebben zonder universitair diploma. De grafiek:
    ...
    Als vierde en laatste hypothese stellen we dat mensen met weinig interesse in het experiment minder scoren, omdat zij minder snel hun best zullen doen.
	...
	Zoals blijkt uit de grafiek van de eerste hypothese, verwachten we een exponentiële groei van de scores naargelang de student meer uren wiskunde had.
    ...
